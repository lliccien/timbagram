							...
							<div class="row">
								<div class="col s12 m10 offset-m1 l8 offset-l2 center-align">
									<form enctype="multipart/form-data" class="form-upload" id="formUpload" onsubmit=${onsubmit}>
										...
										<button id="btnUpload" type="submit" class="btn btn-flat cyan hide"><i class="fa fa-cloud-upload" aria-hidden="true"></i>${translate.message('upload')}</button>
										<button id="btnCancel" type="button" class="btn btn-flat red hide" onclick=${cancel} ><i class="fa fa-times" aria-hidden="true"></i>${translate.message('cancel')}</button>
									</form>
								</div>
							</div>	
							<div class="row">
